...
public class SOSList6Activity extends ActionBarActivity {

    private static final int HIGHLIGHT_COLOR = 0x999be6ff;

    // list of data items
    private List<ListData> mDataList = Arrays.asList(
            new ListData("实验室动物类安全"),
            new ListData("实验室转基因生物安全")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str0=(String) getBaseContext().getResources().getText(R.string.soshelp50);
        str1=(String) getBaseContext().getResources().getText(R.string.soshelp51);
    ...
    private class SampleAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(SOSList6Activity.this, R.layout.sos_list_item_layout, null);
            ...
            holder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 1) {
                        Intent intent = new Intent(SOSList6Activity.this, SOSContentActivity.class);
                        SharedPreferences.Editor editor = getSharedPreferences("soshelp", Context.MODE_WORLD_WRITEABLE).edit();
                        editor.putString("help", str1);
                        editor.putString("help_name","实验室转基因生物安全");
