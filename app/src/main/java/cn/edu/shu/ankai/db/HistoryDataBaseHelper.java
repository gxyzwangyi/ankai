...
public class HistoryDataBaseHelper extends SQLiteOpenHelper {
    ...
    public HistoryDataBaseHelper(Context context) {
        super(context, "qian_history", null, 1);
        // TODO Auto-generated constructor stub
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table qianhistory (_id Integer primary key autoincrement,imageId int,name varchar(20),title varchar(20),show_time varchar(20)," +
                "local varchar(40),ll varchar(40))");
