...
import cn.edu.shu.ankai.utils.LabChange;

public abstract class SlidingUpBaseActivity<S extends Scrollable> extends BaseSlidingActivity implements ObservableScrollViewCallbacks {
...
public List<Device> devicedata = new ArrayList();
    private View.OnClickListener fabClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
Intent intent = new Intent(SlidingUpBaseActivity.this,MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LD = new LabroomData(SlidingUpBaseActivity.this);

        Intent intent=getIntent();



        Object[] cobjs = (Object[]) intent.getSerializableExtra("device");
        for (int i = 0; i < cobjs.length; i++) {
            Device device = (Device) cobjs[i];
            Log.e("艾迪",device.getname());
            devicedata.add(device);
        }
        Log.e("艾迪1",devicedata.toString());

         StringE=intent.getStringExtra("lab_id");
        labroomlist= LD.getIDList(StringE);
        Log.e("艾迪",labroomlist.get(0).toString());
        int i=0;


        String str_id=labroomlist.get(i).get("id").toString();
        String str_serialno=(labroomlist.get(i).get("serialno").toString());
        String str_name=(labroomlist.get(i).get("name").toString());
        String str_parent_id=(labroomlist.get(i).get("parent_id").toString());
        String str_image=(labroomlist.get(i).get("image").toString());
        String str_lab_level=(labroomlist.get(i).get("lab_level").toString());
        String str_lab_type=(labroomlist.get(i).get("lab_type").toString());
        String str_open_flag=(labroomlist.get(i).get("open_flag").toString());
        String str_secrect_flag=(labroomlist.get(i).get("secrect_flag").toString());
        String str_description=(labroomlist.get(i).get("description").toString());
        String str_research_fields=(labroomlist.get(i).get("research_fields").toString());
        String str_director_id=(labroomlist.get(i).get("director_id").toString());
        String str_contact_id=(labroomlist.get(i).get("contact_id").toString());
        String str_contact_phone=(labroomlist.get(i).get("contact_phone").toString());
        String str_web_url=(labroomlist.get(i).get("web_url").toString());
        String str_since_date=(labroomlist.get(i).get("since_date").toString());


        TextView tx1 = (TextView)this.findViewById(R.id.tv1);
        TextView tx2 = (TextView)this.findViewById(R.id.tv2);
        TextView tx3 = (TextView)this.findViewById(R.id.tv3);
        TextView tx4 = (TextView)this.findViewById(R.id.tv4);
        TextView tx5 = (TextView)this.findViewById(R.id.tv5);
        TextView tx6 = (TextView)this.findViewById(R.id.tv6);
        TextView tx7 = (TextView)this.findViewById(R.id.tv7);
        TextView tx8 = (TextView)this.findViewById(R.id.tv8);



        tx1.setText("    实验室编号："+str_serialno);
        tx2.setText("实验室姓名："+str_name+"      创立时间："+str_since_date);
        tx3.setText("实验所属部门："+ LabChange.parentTOschool(str_parent_id));
        tx4.setText("实验室等级："+LabChange.levelTOname(str_lab_level)+"  "+"        实验室类型："+LabChange.typeTOname(str_lab_type));
        tx5.setText("是否开放："+str_open_flag+"     是否保密："+str_secrect_flag);
        tx6.setText("实验室描述："+str_description+"        研究领域："+str_research_fields);
        tx7.setText("实验室主任："+str_director_id+"        实验室联系人："+str_contact_id);
        tx8.setText("实验室联系电话：" + str_contact_phone + "       实验室网站：" + str_web_url);
