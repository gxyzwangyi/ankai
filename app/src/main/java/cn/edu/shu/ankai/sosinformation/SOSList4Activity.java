...
public class SOSList4Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str0=(String) getBaseContext().getResources().getText(R.string.soshelp30);
        str1=(String) getBaseContext().getResources().getText(R.string.soshelp31);
    ...
    private class SampleAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(SOSList4Activity.this, R.layout.sos_list_item_layout, null);
            ...
            holder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 1) {
                        ...
                        editor.putString("help_name","机械危害");
