...
public class SOSList5Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str0=(String) getBaseContext().getResources().getText(R.string.soshelp40);
        str1=(String) getBaseContext().getResources().getText(R.string.soshelp41);
    ...
    private class SampleAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(SOSList5Activity.this, R.layout.sos_list_item_layout, null);
            ...
            holder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 1) {
                        ...
                        editor.putString("help_name","受伤自救");
