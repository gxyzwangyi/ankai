...
public class WebActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        button = (ButtonFloat) this.findViewById(R.id.buttonFloat);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WebActivity.this, SOSInfoActivity.class);
        ...
        myWebView.loadUrl("http://202.121.199.198/AnKaiAPPRes/Bootstrap%20%E4%B8%AD%E6%96%87%E6%96%87%E6%A1%A3.html");// 百度链接
