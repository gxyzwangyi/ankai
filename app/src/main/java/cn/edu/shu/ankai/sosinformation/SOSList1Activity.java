...
public class SOSList1Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int type = intent.getIntExtra(SOSInfoActivity.TYPE, SOSDrawableProvider.SAMPLE_RECT);
           ...
           str0=(String) getBaseContext().getResources().getText(R.string.soshelp00);
           str1=(String) getBaseContext().getResources().getText(R.string.soshelp01);
    ...
    private class SampleAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(SOSList1Activity.this, R.layout.sos_list_item_layout, null);
            ...
            holder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 1) {
                        ...
                        editor.putString("help_name","电气安全");
